...
class ClasificacionIncidenteTestCase(TestSetUp):
    ...
    def test_clasificacion_incidente_listcreate(self):
        ...
        for i in range(self.REPETICIONES):
            ...
            print("Test clasificación: {0}, Clasificación: {1}, No existe ({2}), Existe ({3})".format(i,clasificacion_de_prueba['clasificacion_incidente'],respuesta_no_existente.status_code,response_existente.status_code))