...
class PaisTestCase(TestSetUp):
    ...
    def test_pais_listcreate(self):
        ...
        #Creamos un nuevo nombre de país y lo devolvemos en formato JSON
        ...
        # Ahora debe devolver el ID y el mismo país en el
        ...
        print("Test País: {0}, Existe ({1})".format(pais_prueba_JSON['pais'],respuesta_pais_existente.status_code))
