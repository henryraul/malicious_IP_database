...
class DireccionIPTestCase(TestSetUp):
    ...
    def test_direccionip_listcreate(self):
        ...
        print("Test direccionip_listcreate {0} No existe ({1}) Existe ({2})".format(direccionip_de_prueba['direccion_IP'],respuesta_no_existe.status_code,response_existente.status_code))
    ...
    def test_direccionip_incorrecta_listcreate(self):
        ...
        # Código opcional para seguir la traza de la prueba
        print("Test incorrecta_listcreate {0}  No existe ({1})".format(direccionip_de_prueba_incorrecta['direccion_IP'],respuesta_no_existente.status_code))
    ...
    def test_direccionip_retrieve(self):
        ...
        # Código opcional para seguir la traza de la prueba
        print("Test direccionip_retrieve: IP {0}, Existe ({1}), IP_DB ({2}), IP_Resp ({3}))".format(direccionip_de_prueba.direccion_IP,respuesta_existe.status_code,direccionip_de_prueba.id, respuesta_existe.data["id"]))